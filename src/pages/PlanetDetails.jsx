  ...
  return (
    <>
      <div className="my-6 flex flex-col justify-center items-center md:col-span-2 xl:col-span-1 xl:row-span-2 xl:items-center">
        <img className="max-w-[173px] md:max-w-[285px] xl:max-w-none" src={currentItem.images[image]} />
        {type === 'geology' && (
          <img
      ...
      <div className="text-center md:text-left xl:max-w-[350px] xl:justify-self-end">
        ...
        <p className="mt-4 text-h4 leading-[2] xl:text-body xl:leading-body">{currentItem[type].content}</p>
